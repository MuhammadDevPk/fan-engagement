...
import { ChevronDown, Eye, Pen, BarChart3, Trash2 } from "lucide-react"
...
export function MobileEventCard({ event, onAnalyticsClick }: MobileEventCardProps) {
  ...
  const handleDragEnd = (event: any, info: PanInfo) => {
    if (info.offset.x < -100) {
      ...
      console.log("Swipe to delete triggered")
      // In a real app we'd trigger an alert or callback here
    }
  }
  ...
  return (
    <div className="relative mb-4 group">
      ...
      <div className="absolute inset-y-0 right-0 w-full bg-red-500/20 rounded-xl flex items-center justify-end px-6 border border-red-500/20">
      ...
      <motion.div 
        ...
        className="relative bg-eureka-bg/95 border border-white/10 rounded-xl overflow-hidden z-10"
      >
        <div 
          className="p-4 flex gap-4 bg-white/[0.03] backdrop-blur-sm"
